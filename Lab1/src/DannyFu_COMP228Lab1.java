...
public class DannyFu_COMP228Lab1 {
    public static void main(String[] args) {
        ...
        singer5.setAll(100, "Rei", "34567 Kyoto House", 20500101, 3);
        System.out.println(singer5.getAll());
        System.out.println("========================");
    }
}
class Singers {
    public int singerID = 0;
    public String singerName = "Hoshino Ruby";
    public String singerAddress = "1234 Tokyo Apartment";
    public int dateOfBirth = 20200123;
    public int numOfAlbumPublished = 1;
